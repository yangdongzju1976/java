public class Question 
{
	...
	{
		Student[] array=new Student[5];//数组定义，注意格式
		array[0]=new Student(); //数组的每一个元素都是一个对象。对象需要逐一生成。
		array[0].age=12;
	...
	static Student[] Output(Student array[],int i){ //方法的定义。数组的大小由数组名.length值入，不需要其他变量。输出也不需要返回值。
