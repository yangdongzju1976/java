		...
		timer = new Timer(60,new ActionListener(){
			@Override
				...
				*/
				...
				//3.逆时什转一圈
					if(snakeX[0]>25&&snakeX[0]<=300&&snakeY[0]<225)
						snakeX[0]-=25;	//开始向左走（1）
					else if (snakeX[0]==25&&snakeY[0]<725)
							snakeY[0]+=25;//碰到左壁，向下走
						else if (snakeY[0]==725&&snakeX[0]<750)
								snakeX[0]+=25;//碰到下壁，向右走
							else if (snakeX[0]==750&&snakeY[0]>75)
									snakeY[0]-=25;//碰到右壁，向上走
								else if (snakeY[0]==75&&snakeX[0]>25)
										snakeX[0]-=25;//碰到上壁，向左走。（2）
					
					//（1）与（2）都是向左走，但条件不同。为什么？
